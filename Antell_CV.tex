...
\section{Software}
\cvitem{divvy}{Developed an R package to spatially subsample biodiversity data, for fair comparisons through time and across environments (Antell \textit{et al.} 2020, 2023).}
...
\cvitem{Install at}{\href{https://github.com/GawainAntell/divvy}{github.com/GawainAntell/divvy}; \href{https://github.com/GawainAntell/kerneval}{github.com/GawainAntell/kerneval}}
\hfill 
...
\cvitem{Graduate Student Mentorship Program}{UC Riverside, daylong training, 2023.}
...
\section{Service}
\cvitem{Peer reviewer}{\textit{Science Advances, Global Ecology \& Biogeography, Paleobiology, Palaeontology, Am.\ Naturalist, Am.\ J.\ Botany, Royal Society and Nature families}}
